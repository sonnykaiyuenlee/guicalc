...
text_entry = ""
expression_style = wx.TE_READONLY | wx.TE_MULTILINE |wx.TE_RICH | wx.TE_PROCESS_ENTER
...
while 1:
    display_expression.SetDefaultStyle(TextAttr(NullColour, NullColour, NullFont, wx.TEXT_ALIGNMENT_LEFT))
    ...
    if entry_result == wx.ID_CANCEL:
        ...
        display_expression.SetDefaultStyle(TextAttr(NullColour, NullColour, NullFont, wx.TEXT_ALIGNMENT_RIGHT))
